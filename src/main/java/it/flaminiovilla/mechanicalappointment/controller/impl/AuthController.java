...
import it.flaminiovilla.mechanicalappointment.model.dto.*;
...
import it.flaminiovilla.mechanicalappointment.repository.RoleRepository;
...
import it.flaminiovilla.mechanicalappointment.security.RefreshTokenService;
...
public class AuthController {
    ...
    public ResponseEntity<?> registerUser(@Valid @RequestBody SignUpRequestDto signUpRequestDto) {
        ...
        if(userRepository.existsByEmail(signUpRequestDto.getEmail()))
            return ResponseEntity.badRequest().body(new ApiResponseDto(false, "Email address already in use."));
